...
?>
   ...
   <form action="" class="box" method="POST">
      ...
      <div class="name" style ="font-size: 25px; color:var(--orange);"><?= $fetch_cate['name']; ?></div>
      <div class="description" style ="font-size: 15px;"><?= $fetch_cate['description']; ?></div>
      ...
      <input type="hidden" name="image1" value="<?= $fetch_cate['image1']; ?>">
   </form>
   <?php endforeach  ?>
</section>
